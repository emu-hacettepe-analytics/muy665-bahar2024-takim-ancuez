...
Kısa bir not olarak, derin öğrenme ve pekiştirmeli öğrenme yapay zeka araçları, yönlendirebilme ve karara çevirebilme başlıklarında incelenebilirken; yorumlanabilirlik ve gürbüzlük konularında zayıf kalmaktadır. Bu duruma öznitelik çıkarımınında personelin tamamiyle ilerleyişten çıkarılması ve teknolojik yetersizlik neden olmaktadır.
